...
const run1 = new Running([5678, -45678], 25, 200, 13);
const cycle1 = new Cycling([5678, -45678], 15, 100, 23);
console.log(run1);
console.log(cycle1);
...
//     console.log(`https://www.google.com/maps/@${lat},${long},5z`);
//   },
//   err => {
//     alert('No pos found');
//   }
